...
NSString *const JiaAlertViewWillShowNotification = @"JiaAlertViewWillShowNotification";
NSString *const JiaAlertViewDidShowNotification = @"JiaAlertViewDidShowNotification";
NSString *const JiaAlertViewWillDismissNotification = @"JiaAlertViewWillDismissNotification";
NSString *const JiaAlertViewDidDismissNotification = @"JiaAlertViewDidDismissNotification";
...
@protocol JiaViewControllerDelegate <NSObject>

@optional
- (void)coverViewTouched;

@end
@interface JiaAlertView () <JiaViewControllerDelegate>
...
@property (nonatomic, strong) JiaAlertView *previousAlert;
...
@property (nonatomic, weak) JiaAlertView *alertView;
@property (nonatomic, weak) id <JiaViewControllerDelegate> delegate;
...
- (void)showAlert{
    [[NSNotificationCenter defaultCenter] postNotificationName:JiaAlertViewWillShowNotification object:self];
    ...
    [UIView animateWithDuration:duration delay:0 options:UIViewAnimationOptionCurveLinear animations:^{
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:JiaAlertViewDidShowNotification object:self.alertView];
    }];
...
- (void)hideAlertWithCompletion:(void(^)(void))completion{
    [[NSNotificationCenter defaultCenter] postNotificationName:JiaAlertViewWillDismissNotification object:self];
    self.alertView.alertReady = NO;
    ...
    [UIView animateWithDuration:duration delay:0 options:UIViewAnimationOptionCurveLinear animations:^{
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:JiaAlertViewDidDismissNotification object:self];
    }];
...
+ (void)showOneButtonWithTitle:(NSString *)title Message:(NSString *)message ButtonType:(JiaAlertViewButtonType)buttonType ButtonTitle:(NSString *)buttonTitle Click:(clickHandle)click{
    ...
    JiaAlertView *alertView = [JiaAlertView new];
...
+ (void)showTwoButtonsWithTitle:(NSString *)title Message:(NSString *)message ButtonType:(JiaAlertViewButtonType)
buttonType ButtonTitle:(NSString *)buttonTitle Click:(clickHandle)click ButtonType:(JiaAlertViewButtonType)buttonType1 ButtonTitle:(NSString *)buttonTitle1 Click:(clickHandle)click1{
    id newClick = click;
    if (!newClick) {
        newClick = [NSNull null];
    }
...
- (void)showAlert{
    ...
    JiaAlertView *previousAlert = nil;
    if (count > 1) {
...
- (void)dismissAlertWithCompletion:(void(^)(void))completion{
    [self.vc hideAlertWithCompletion:^{
        ...
        NSInteger count = [jCSingleTon shareSingleTon].alertStack.count;
        if (count > 0) {
            JiaAlertView *lastAlert = [jCSingleTon shareSingleTon].alertStack.lastObject;
            [lastAlert showAlert];
        }
    }];
}
...
- (void)setButton:(UIButton *)btn BackgroundWithButonType:(JiaAlertViewButtonType)buttonType{
    UIColor *textColor = nil;
    UIImage *normalImage = nil;
    UIImage *highImage = nil;
    //可以不断的扩展Button样式
    switch (buttonType) {
        case JiaAlertViewButtonTypeDefault:
            ...
            break;
        case JiaAlertViewButtonTypeCancel:
            ...
            textColor = WJYColor(255, 255, 255);
            break;
        case JiaAlertViewButtonTypeWarn:
            ...
            textColor = WJYColor(255, 255, 255);
            break;
        case JiaAlertViewButtonTypeNone:
            
            textColor = [UIColor blueColor];
            [btn setTitleColor:textColor forState:UIControlStateNormal];
            break;
        case JiaAlertViewButtonTypeHeight:
